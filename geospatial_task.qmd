...
#| label: Import data
year = '2012'
country = 'conus' # can be 'conus', 'mexico', or 'canada'
...
```{python}
coords = raw_h5['coordinates'][...] # save coordinates data as array, ellipses makes it an array rather than HDF5
POI = (34.420830, -119.698189) # Santa Barbara
...
plt.xlabel("Month")
plt.ylabel("Average Wind Speed at 100m Height (m/s)")
plt.title("Comparing Average Monthly Wind Speeds in Santa Barbara at 100 Meters \n with the Annual Average for 2012")
plt.legend()
plt.show()
```
...
### Hourly Averages for Each Month
...
### A Function to Find Indexes for Multiple Points of Interest or a Bounding Box
